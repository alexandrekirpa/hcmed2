...
var event = new Event('change');document.getElementById("cmb_procedimento").dispatchEvent(event); document.getElementById("Hemacia_13__Selecionado").click(); document.getElementById("Hemacia_13__Justificativa").value="RESERVA CIRURGICA TX HEPATICO"; document.getElementById("CON_HEMACIA_HB").value="10,0"; document.getElementById("CON_HEMACIA_HT").value="30"; document.getElementById("cmbQuantidade").selectedIndex=10; }

else if(cs=='2'){

 document.getElementById("cmb_procedimento").selectedIndex=25;var event = new Event('change');document.getElementById("cmb_procedimento").dispatchEvent(event); document.getElementById("Plaqueta_10__Selecionado").click(); document.getElementById("Plaqueta_7__Selecionado").click(); document.getElementById("Plaqueta_10__Justificativa").value="RESERVA CIRURGICA TX HEPATICO"; document.getElementById("CON_PLAQUETA_PLAQUETA").value="150.000"; document.getElementById("cmbQuantidade").selectedIndex=10; }

else if(cs=='3'){
 document.getElementById("cmb_procedimento").selectedIndex=37;var event = new Event('change');document.getElementById("cmb_procedimento").dispatchEvent(event); document.getElementById("Plasma_9__Selecionado").click(); document.getElementById("Plasma_9__Justificativa").value="RESERVA CIRURGICA TX HEPATICO"; }else{alert('erro')}; void(0)
